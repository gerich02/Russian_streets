    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("title", models.TextField(default=None, verbose_name="Текст")),
            ],
        ),
        migrations.CreateModel(
            name="Region",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("address", models.TextField(default=None, verbose_name="Адрес")),
                (
                    "city",
                    models.ForeignKey(
                        default=None,
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        default=datetime.datetime(2024, 5, 15, 17, 15, 18, 116501),
                ...
                (
                    "end_date_time",
                    models.DateTimeField(
                        default=datetime.datetime(2024, 5, 15, 22, 15, 18, 116501),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "source",
                    models.CharField(
                        default=None, max_length=150, verbose_name="Источник"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        max_length=100,
                        verbose_name="Социальная сеть для связи",
                    ),
                ),
                (
                    "is_staff",
                ...
                (
                    "passport_series",
                    models.CharField(
                        max_length=10, unique=True, verbose_name="Серия пасспорта"
                    ),
                ),
                (
                    "passport_number",
                    models.CharField(
                        max_length=10, unique=True, verbose_name="Номер пасспорта"
                    ),
                ),
                (
                    "passport_giver",
                    models.CharField(max_length=255, verbose_name="Кем выдан пасспорт"),
                ),
                (
                    "passport_date",
                    models.DateField(verbose_name="Дата выдачи пасспорта"),
                ),
                (
                    "city",
                    models.ForeignKey(
            ...
            managers=[
                ("objects", entitys.managers.UserManager()),
            ],
        ),
    ]
